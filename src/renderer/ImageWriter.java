...
/**
 * Image writer class combines accumulation of pixel color matrix
 * and finally produces a non-optimized jpeg image from this matrix.
 * The class is responsible for holding image-related
 * parameters of View Plane - pixel matrix size and resolution.
 *
 * @author Dan
 */

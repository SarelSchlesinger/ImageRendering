...
public class Color {
    ...
    public Color(double r, double g, double b) {
        if (r < 0 || g < 0 || b < 0)
            throw new IllegalArgumentException("The numbers should be in a range between 0 and 255");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Color other)
            return isZero(this.getRgb().getD1() - other.getRgb().getD1()) &&
                    isZero(this.getRgb().getD2() - other.getRgb().getD2()) &&
                    isZero(this.getRgb().getD3() - other.getRgb().getD3());
        return false;
    }
    ...
    public static Color avg(List<Color> colorsList) {
        if (colorsList.size() == 1) return colorsList.get(0);
        Double3 double3 = Double3.ZERO;
        for (Color col : colorsList) {
            double3 = double3.add(col.getRgb());
        }
        return new Color(double3.reduce(colorsList.size()));
    }
